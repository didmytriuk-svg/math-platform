...
export const metadata: Metadata = {
  title: {
    default: 'VOLYA ACADEMY — Матеріали для викладачів математики 5–11 класів',
    template: '%s | VOLYA ACADEMY',
  },
  description:
    'Готові презентації, інтерактивні HTML5-ігри, самостійні та контрольні роботи з математики для вчителів і репетиторів.',
  metadataBase: new URL('https://my-platform.vercel.app'), // Замініть згодом на ваш реальний домен на Vercel
  openGraph: {
    title: 'VOLYA ACADEMY — Матеріали для викладачів математики 5–11 класів',
    description: 'Готові презентації, інтерактивні HTML5-ігри, самостійні та контрольні роботи з математики для вчителів і репетиторів.',
