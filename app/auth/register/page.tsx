  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Реєстрація викладача</h1>
        <p className="text-sm text-gray-600 mb-6">Створіть акаунт для доступу до матеріалів платформи.</p>
