...
export default async function HomePage() {
  ...
  const materialTypesList = [
    ...
    { title: 'Інтерактивні ігри', slug: 'game', desc: 'HTML5-тренажери усного рахунку та вікторини' },
  ...
  const pricingTiers = [
    {
      ...
      price: '0 грн',
      period: 'назавжди',
      desc: 'Повний доступ до 1 обраного блоку тем для перевірки формату на уроці.',
      features: [
        'Повний перший блок будь-якого класу',
        'Онлайн-перегляд тем усього каталогу',
        'Текстові плани та конспекти уроків',
      ],
    ...
    },
    {
      ...
      features: [
        'Усі матеріали одного обраного класу',
    ...
    },
    {
      ...
      price: '3 900 грн',
      period: 'на 1 рік за заклад',
      desc: 'Ліцензія для всіх учителів математики школи під одним договором.',
      features: [
        'Доступ для всієї кафедри математики',
        'Офіційний договір та рахунок для юросіб',
        'Повний доступ до всіх 5–11 класів',
        'Методичний супровід закладу',
      ],
  ...
  return (
    <div className="space-y-16 sm:space-y-24 py-10 sm:py-16">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-8">
        ...
        <div className="space-y-4 max-w-4xl mx-auto">
          ...
          <p className="text-sm sm:text-base text-[#5E687E] max-w-2xl mx-auto leading-relaxed">
            Готові презентації, інтерактивні HTML5-ігри, самостійні та контрольні роботи з відповідями для викладання математики 5–11 класів.
          </p>
        </div>
            ...
            grades.map((grade) => (
              ...
              >
                <span className="font-display font-black text-2xl sm:text-3xl text-[#0D1117] group-hover:text-[#1E56FF] transition-colors">
                  {grade.number || grade.name.replace(/\D/g, '')}
                </span>
              ...
              >
                ...
                <div className="pt-5 mt-5 border-t border-[#F1F4FA] flex items-center justify-between">
                  <span className="text-[11px] font-mono-math text-[#94A3B8]">
                    {m.is_interactive ? 'Інтерактивний' : 'Файл уроку'}
                  </span>
                  <Link
                    href={`/material/${m.id}`}
      ...
      {/* 5. ОРГАНІЧНО ІНТЕГРОВАНИЙ БЛОК ТАРИФІВ ТА ПІДПИСКИ */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        <div className="bg-white border border-[#E2E8F4] rounded-3xl p-8 sm:p-12 shadow-xs space-y-10">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            ...
            <h2 className="font-display font-black text-2xl sm:text-4xl text-[#0D1117] tracking-tight">
              Обирайте рівень доступу до матеріалів
            </h2>
            <p className="text-xs sm:text-sm text-[#5E687E] leading-relaxed">
              Без прихованих автосписань. Працюйте з демо-розділом безкоштовно або отримайте повний доступ до 5–11 класів.
            </p>
          </div>
              ...
              >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <h3 className="font-display font-black text-lg text-[#0D1117] mt-2">
                      {tier.name}
                    </h3>
                  ...
                  <div className="pt-4 border-t border-[#EDF2FA] space-y-2">
          ...
          <div className="pt-4 border-t border-[#F1F4FA] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#5E687E]">
            <div className="flex items-center gap-2">
              ...
              <span>Офіційні матеріали за чинними модельними програмами МОН</span>
            </div>
            <Link
              href="/pricing"
              className="font-display font-bold text-xs text-[#1E56FF] hover:underline inline-flex items-center gap-1"
            >
              Детальніше про всі тарифи
